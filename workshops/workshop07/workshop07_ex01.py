...
class Parameters:
    ...
    # TODO: Add mean reversion parameter for scenario B (persistent shock)
...
def simulate_olg(z_series, eq: SteadyState):
    ...
    # TODO: Add code to simulate the transition dynamics of the OLG model 
    # for a given TFP series
...
if __name__ == '__main__':
    ...
    # TODO: Create TFP time series for the transitory shock
    # TODO: Compute transition dynamics for the transitory shock scenario
    # TODO: Plot the transition dynamics for the transitory shock scenario

    # -- Scenario B: Persistent TFP shock --

    # TODO: Create TFP time series for the persistent shock
    # TODO: Compute transition dynamics for the persistent shock scenario
    # TODO: Plot the transition dynamics for the persistent shock scenario
