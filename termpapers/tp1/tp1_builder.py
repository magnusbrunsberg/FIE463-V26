...
add_code("""# Importing necessary libraries for numerical computations, optimization, and plotting
import numpy as np
...
add_markdown("""Because the wealth tax takes out part of capitalists inherited wealth and cuts their net return on savings, the incentive to accumulate assets diminishes heavily. This directly lowers the savings rate $s_t$, which shrinks total investment and reduces the aggregate capital stock $K$ in the new steady state.
